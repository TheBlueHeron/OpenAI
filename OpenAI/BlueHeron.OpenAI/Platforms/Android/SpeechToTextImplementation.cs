...
{
    public Action<SpeechRecognizerError> Error
    {
        get; set;
    }
    public Action<string> PartialResults
    {
        get; set;
    }
    public Action<string> Results
    {
        get; set;
    }
    ...
    private static void SendResults(Bundle bundle, Action<string> action)
    {
